...
angular.module("korpApp").component("simpleSearch", {
            ...
            <div class="sm_flex justify-between">
                <div>
                    ...
                    <div class="opts">
                        ...
                        <input id="diacriticChk" type="checkbox" ng-model="$ctrl.isDiacriticInsensitive" />
                        <label for="diacriticChk"> {{'diacritic_insensitive' | loc:$root.lang}} </label>
    ...
    controller: [
        ...
        function ($location, $rootScope, $scope, searches, compareSearches, lexicons, $uibModal, $timeout) {
            ...
            ctrl.isDiacriticInsensitive = true
            ...
            ctrl.updateSearch = function () {
                ...
                $location.search("isDiacriticInsensitive", ctrl.isDiacriticInsensitive ? true : null)
            ...
            ctrl.getCQP = function () {
                let suffix, val
                let currentText = (ctrl.currentText || "").trim()

                if (currentText) {
                    if (ctrl.isDiacriticInsensitive) {
                        currentText = currentText
                            .replace(/a|â|á|à|ā|ă/gi,"[a|â|á|à|ā|ă]")
                            .replace(/e|ê|é|è|ē|ĕ/gi,"[e|ê|é|è|ē|ĕ]")
                            .replace(/i|î|í|ì|ī|ĭ/gi,"[i|î|í|ì|ī|ĭ]")
                            .replace(/o|ô|ó|ò|ō|ŏ/gi,"[o|ô|ó|ò|ō|ŏ]")
                            .replace(/u|û|ú|ù|ū|ŭ/gi,"[u|û|ú|ù|ū|ŭ]")
                            .replace(/l|ƚ/gi,"[l|ƚ]")
                            .replace(/'|ʔ|h|\?/gi,"['|ʔ|h|\?/]")
                    }
            ...
            $scope.$watch(
                ...
                (search) => {
                    ...
                    ctrl.isDiacriticInsensitive = search.isDiacriticInsensitive != null
                }
            )
